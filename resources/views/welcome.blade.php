                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('img/testimonials/neco.jpg') }}" class="testimonial-img" alt="">
                            <h3>John Doe</h3>
                            <h4>Ceo &amp; Founder</h4>
                            <p>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Love your goods good quality year after year and I tell everyone to shop at AMININ
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('img/testimonials/neco.jpg') }}" class="testimonial-img" alt="">
                            <h3>Lalo salamanca</h3>
                            <h4>Development</h4>
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Super soft t-shirts at such a great price, i&apos;d have to pay 2 or 3 times more at AMININ
                                for this quality
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Amazing service from start to finish i had a fabulous experience shopping in AMININ
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Clothing products at AMININ are very good and of good quality, i very proud for AMININ
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                I like shopping at AMININ because the website is very easy for customers to understand
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Very fast response & helpful service, AMININ is best recommend
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div>
